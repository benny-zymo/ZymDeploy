...
class AcquisitionAnalyzer:
    ...
    def analyze_results(self, results_folder: str, plate_type: str = None, acquisition_mode: str = None) -> Dict[str, Any]:
        """
        ...
        Args:
            ...
            plate_type: Type de plaque (optionnel, détecté automatiquement si non fourni)
            acquisition_mode: Mode d'acquisition (optionnel, détecté automatiquement si non fourni)
        ...
        detected_plate_type = plate_type if plate_type else self._detect_plate_type(results_folder)
        detected_acquisition_mode = acquisition_mode if acquisition_mode else self._detect_acquisition_mode(results_folder)
        ...
        results = {
            ...
            "plate_type": detected_plate_type,
            "acquisition_mode": detected_acquisition_mode,
            "data": None,
            "statistics": None,
            "graphs": []
        }
